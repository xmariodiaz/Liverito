...
export default function Roboo({ robots, height = "400px" }: RobooProps) {
  ...
  useEffect(() => {
    ...
    robots.forEach((robot) => {
      if (!robot.lastKnownLocation) return; /// Todo: Please check this type - macheteeee
  ...
  return (
    <>
      {/* Load Maps JS API */}
      <Script
        src={`https://maps.googleapis.com/maps/api/js?key=AIzaSyB10WRT8D9dw3HyRw8xJ_2vK2OkUZkMMn8`} // TODO: Secure this apiKey in GCP
